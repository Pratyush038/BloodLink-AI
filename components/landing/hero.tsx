        ...
        <BlurFade delay={0.25} inView>
          ...
          >
            <AnimatedShinyText className="inline-flex items-center justify-center px-4 py-1 transition ease-out hover:text-neutral-600 hover:duration-300 hover:dark:text-neutral-400">
              <span>✨ TRANSFORMING BLOOD DONATIONS</span>
      ...
      <div className="mt-10 text-center">
        ...
        <BlurFade delay={0.75} inView>
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-muted-foreground sm:mt-8">
            BloodLink AI predicts upcoming blood shortages and securely coordinates donors and blood banks in real time, ensuring timely availability and zero wastage of critical blood units.
          </p>
        </BlurFade>
      </div>
        ...
        <BlurFade delay={1.0} inView>
          <Link href="/chat">
            <ShimmerButton
              ...
              background="linear-gradient(to right, #ff0000ff, #ff0059ff)"
            >
        ...
        <BlurFade delay={1.25} inView>
          <Link href="/dashboard">
            <div>
              <ShimmerButton
                className="flex items-center gap-2 px-6 py-3 text-base sm:text-lg"
                background="linear-gradient(to right, #af7373ff, #ac2121ff)"
              >
                <span className="whitespace-pre-wrap text-center font-medium leading-none tracking-tight text-white">
                  Learn More
                </span>
